...
public class ActivityLogRepository: IActivityLogRepository
{
    ...
    public async Task<IReadOnlyList<ActivityLog>> GetLogsPageAsync(GetActivityLogsRequestModel model)
    {
        return await GetLogsAsync(model.EventDateFrom, model.EventDateTo, model.EventTypes, 
